...
**使用方法**
去火山引擎注册账号，免费申请一个豆包1.6lite的api，然后去https://www.vocu.ai注册一个账号，在assests/audio文件夹挑一个时间稍长的语音复刻一个克里斯蒂娜音频复制角色id，然后申请一个api，到软件设置中填入即可
...
- [ ] 添加更多的语言模型选项和音频模型选项（20260214，豆包2.0seed发布了，但是我懒得更新了，现在的1.6 lite其实够用了，下个版本我会加入模型选单的，或者你自己在代码里改一下模型名称其实也就可以了）
- [ ] 我会尝试优化音频的
