          ...
          content:
            application/json:
              schema:
                ...
                x-apifox-ignore-properties: []
          headers: {}
          x-apifox-name: 未找到指定 ID 的异步生成任务
      security:
        - bearer: []
      x-apifox-folder: 语音生成
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/5878926/apis/api-261932866-run
components:
  schemas:
    Generate:
      type: object
